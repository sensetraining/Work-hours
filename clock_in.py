...
def adminPage(name,position,box,names,selected,option1,option2):
    ...
    backButton = tk.Button(plainBox1,command=lambda:main(name,position,plainBox1),text="Back",fg="white",bg="#ff4747",font=("Helvetica", 16,"bold"))
    ...
    if option1 == True:
        ...
        plusButton = tk.Button(plainBox1,text="+",command=lambda:addSelected(name,position,value.get(),names,plainBox1,selected,option1,option2),bg="white",fg="black",font=("Helvetica", 26))
    ...
    if option2 == True:
        ...
        minusButton = tk.Button(plainBox1,text="-",command=lambda:minusSelected(name,position,value2.get(),names,plainBox1,selected,option1,option2),bg="white",fg="black",font=("Helvetica", 26))
        minusButton.place(x=210,y=yValue,height=40,width=40)   


def addSelected(name,position,value,names,box,selected,option1,option2):
    box.destroy()
    ...
    adminPage(name,position,box,names,selected,option1,option2)

def minusSelected(name,position,value,names,box,selected,option1,option2):
    box.destroy
    names.append(value)
...
def main(name,position,box):
    ...
    if admin == True:
        ...
        adminButton = tk.Button(plainBox1,command=lambda:adminPage(name,position,plainBox1,names,selected,option1,option2),text="🖳",fg="black",bg="#fcba03",font=("Helvetica", 26,"bold"))
