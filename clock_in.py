...
def adminPage(name,position,box):
...
def main(name,position,box):
    ...
    if admin == True:
        adminButton = tk.Button(plainBox1,command=lambda:adminPage(name,position,plainBox1),text="🖳",fg="black",bg="#fcba03",font=("Helvetica", 26,"bold"))
